...
public:
   ...
   void interpret(string &input, int &total)
   { // Template Method
      int index = 0;
...
private:
   virtual char one() = 0;
   virtual string four() = 0; // placeholders
   virtual char five() = 0;
   virtual string nine() = 0;    // placeholders
   virtual int multiplier() = 0; // placeholders
   static Thousand thousands;
   static Hundred hundreds;
   static Ten tens;
   static One ones;
};
