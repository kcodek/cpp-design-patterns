...
// If making a good design is difficult, then making a good reusable design is even harder, 
// and any amount of process description cannot substitute for the skill, imagination, and experience of a good designer. 
// A process can only support the creative work, and ensure that things are done and recorded properly. [Karlsson et al, REBOOT]