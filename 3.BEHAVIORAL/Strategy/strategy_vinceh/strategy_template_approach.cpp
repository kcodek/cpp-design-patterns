...
// This technique is appropriate if: 
// 1) the Strategy can be selected at compile-time, and  2) it does not have to be changed at run-time.
...
// The inheritance approach offers more options and expressiveness. The template approach offers mildly better efficiency.
